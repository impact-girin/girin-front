...
export default function Home() {
  ...
  return <>
    ...
    <Box>
      <Flex onClick={e => navigate.push('#')} borderRadius={'20px'} padding={'2px 0 '} justifyContent={'center'} w={'90px'} fontSize={'14px'} color={'#2DD790'} margin={'16px'} marginBottom={'0'} style={{ border: '1px solid #2DD790' }}>
